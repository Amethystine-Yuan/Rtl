...
// Test all skews and calculate the average
module dut_tb2 ();
    ...
    integer    latency_all_sum_circuit00_integer;
    integer    latency_all_sum_circuit01_integer;
    integer    latency_all_sum_circuit02_integer;
    integer    latency_all_sum_circuit03_integer;
    integer    latency_all_sum_circuit10_integer;
    integer    latency_all_sum_circuit11_integer;
    integer    latency_all_sum_circuit12_integer;
    integer    latency_all_sum_circuit13_integer;
    integer    latency_all_sum_circuit20_integer;
    integer    latency_all_sum_circuit21_integer;
    integer    latency_all_sum_circuit22_integer;
    integer    latency_all_sum_circuit23_integer;
    integer    latency_all_sum_circuit30_integer;
    integer    latency_all_sum_circuit31_integer;
    integer    latency_all_sum_circuit32_integer;
    integer    latency_all_sum_circuit33_integer;

    real    latency_all_sum_circuit00;
    real    latency_all_sum_circuit01;
    real    latency_all_sum_circuit02;
    real    latency_all_sum_circuit03;
    real    latency_all_sum_circuit10;
    real    latency_all_sum_circuit11;
    real    latency_all_sum_circuit12;
    real    latency_all_sum_circuit13;
    real    latency_all_sum_circuit20;
    real    latency_all_sum_circuit21;
    real    latency_all_sum_circuit22;
    real    latency_all_sum_circuit23;
    real    latency_all_sum_circuit30;
    real    latency_all_sum_circuit31;
    real    latency_all_sum_circuit32;
    real    latency_all_sum_circuit33;

    real    latency_all_min_circuit00;
    real    latency_all_min_circuit01;
    real    latency_all_min_circuit02;
    real    latency_all_min_circuit03;
    real    latency_all_min_circuit10;
    real    latency_all_min_circuit11;
    real    latency_all_min_circuit12;
    real    latency_all_min_circuit13;
    real    latency_all_min_circuit20;
    real    latency_all_min_circuit21;
    real    latency_all_min_circuit22;
    real    latency_all_min_circuit23;
    real    latency_all_min_circuit30;
    real    latency_all_min_circuit31;
    real    latency_all_min_circuit32;
    real    latency_all_min_circuit33;

    real    latency_all_max_circuit00;
    real    latency_all_max_circuit01;
    real    latency_all_max_circuit02;
    real    latency_all_max_circuit03;
    real    latency_all_max_circuit10;
    real    latency_all_max_circuit11;
    real    latency_all_max_circuit12;
    real    latency_all_max_circuit13;
    real    latency_all_max_circuit20;
    real    latency_all_max_circuit21;
    real    latency_all_max_circuit22;
    real    latency_all_max_circuit23;
    real    latency_all_max_circuit30;
    real    latency_all_max_circuit31;
    real    latency_all_max_circuit32;
    real    latency_all_max_circuit33;
...
// end
    ...
    // reg clock_global_2, clock_global_true;
    integer j;
    NoC dut(
...
reg clk15_tmp;
   ...
   integer max_T;
    ...
    initial begin
        cnt = 0;
        // $error("TRANFER FAILED");
        file_result = $fopen("skew_0218.txt");
        //clk_global = 0;
        clk_global_tmp = 0;
        // clock_global_2 = 0;
        clk0 = 0;
...
*/
        ...
        latency_all_sum_circuit00 = 0;
        latency_all_sum_circuit01 = 0;
        latency_all_sum_circuit02 = 0;
        latency_all_sum_circuit03 = 0;
        latency_all_sum_circuit10 = 0;
        latency_all_sum_circuit11 = 0;
        latency_all_sum_circuit12 = 0;
        latency_all_sum_circuit13 = 0;
        latency_all_sum_circuit20 = 0;
        latency_all_sum_circuit21 = 0;
        latency_all_sum_circuit22 = 0;
        latency_all_sum_circuit23 = 0;
        latency_all_sum_circuit30 = 0;
        latency_all_sum_circuit31 = 0;
        latency_all_sum_circuit32 = 0;
        latency_all_sum_circuit33 = 0;

        latency_all_sum_circuit00_integer = 0;
        latency_all_sum_circuit01_integer = 0;
        latency_all_sum_circuit02_integer = 0;
        latency_all_sum_circuit03_integer = 0;
        latency_all_sum_circuit10_integer = 0;
        latency_all_sum_circuit11_integer = 0;
        latency_all_sum_circuit12_integer = 0;
        latency_all_sum_circuit13_integer = 0;
        latency_all_sum_circuit20_integer = 0;
        latency_all_sum_circuit21_integer = 0;
        latency_all_sum_circuit22_integer = 0;
        latency_all_sum_circuit23_integer = 0;
        latency_all_sum_circuit30_integer = 0;
        latency_all_sum_circuit31_integer = 0;
        latency_all_sum_circuit32_integer = 0;
        latency_all_sum_circuit33_integer = 0;
    

        latency_all_max_circuit00 = 0;
        latency_all_max_circuit01 = 0;
        latency_all_max_circuit02 = 0;
        latency_all_max_circuit03 = 0;
        latency_all_max_circuit10 = 0;
        latency_all_max_circuit11 = 0;
        latency_all_max_circuit12 = 0;
        latency_all_max_circuit13 = 0;
        latency_all_max_circuit20 = 0;
        latency_all_max_circuit21 = 0;
        latency_all_max_circuit22 = 0;
        latency_all_max_circuit23 = 0;
        latency_all_max_circuit30 = 0;
        latency_all_max_circuit31 = 0;
        latency_all_max_circuit32 = 0;
        latency_all_max_circuit33 = 0;
    
        latency_all_min_circuit00 = 9999;
        latency_all_min_circuit01 = 9999;
        latency_all_min_circuit02 = 9999;
        latency_all_min_circuit03 = 9999;
        latency_all_min_circuit10 = 9999;
        latency_all_min_circuit11 = 9999;
        latency_all_min_circuit12 = 9999;
        latency_all_min_circuit13 = 9999;
        latency_all_min_circuit20 = 9999;
        latency_all_min_circuit21 = 9999;
        latency_all_min_circuit22 = 9999;
        latency_all_min_circuit23 = 9999;
        latency_all_min_circuit30 = 9999;
...
/*
   //base=5
        ...
        for(j=0; j<2*max_T; j=j+5) begin
           ...
           if(latency_all_max_circuit00<latency_max_circuit00)
                latency_all_max_circuit00 = latency_max_circuit00;
            if(latency_all_min_circuit00>latency_min_circuit00)
                latency_all_min_circuit00 = latency_min_circuit00;
            
            if(latency_all_max_circuit01<latency_max_circuit01)
                latency_all_max_circuit01 = latency_max_circuit01;
            if(latency_all_min_circuit01>latency_min_circuit01)
                latency_all_min_circuit01 = latency_min_circuit01;

            if(latency_all_max_circuit02<latency_max_circuit02)
                latency_all_max_circuit02 = latency_max_circuit02;
            if(latency_all_min_circuit02>latency_min_circuit02)
                latency_all_min_circuit02 = latency_min_circuit02;

            if(latency_all_max_circuit03<latency_max_circuit03)
                latency_all_max_circuit03 = latency_max_circuit03;
            if(latency_all_min_circuit03>latency_min_circuit03)
                latency_all_min_circuit03 = latency_min_circuit03;

            
            if(latency_all_max_circuit10<latency_max_circuit10)
                latency_all_max_circuit10 = latency_max_circuit10;
            if(latency_all_min_circuit10>latency_min_circuit10)
                latency_all_min_circuit10 = latency_min_circuit10;
            
            if(latency_all_max_circuit11<latency_max_circuit11)
                latency_all_max_circuit11 = latency_max_circuit11;
            if(latency_all_min_circuit11>latency_min_circuit11)
                latency_all_min_circuit11 = latency_min_circuit11;

            if(latency_all_max_circuit12<latency_max_circuit12)
                latency_all_max_circuit12 = latency_max_circuit12;
            if(latency_all_min_circuit12>latency_min_circuit12)
                latency_all_min_circuit12 = latency_min_circuit12;

            if(latency_all_max_circuit13<latency_max_circuit13)
                latency_all_max_circuit13 = latency_max_circuit13;
            if(latency_all_min_circuit13>latency_min_circuit13)
                latency_all_min_circuit13 = latency_min_circuit13;

            
            if(latency_all_max_circuit20<latency_max_circuit20)
                latency_all_max_circuit20 = latency_max_circuit20;
            if(latency_all_min_circuit20>latency_min_circuit20)
                latency_all_min_circuit20 = latency_min_circuit20;
            
            if(latency_all_max_circuit21<latency_max_circuit21)
                latency_all_max_circuit21 = latency_max_circuit21;
            if(latency_all_min_circuit21>latency_min_circuit21)
                latency_all_min_circuit21 = latency_min_circuit21;

            if(latency_all_max_circuit22<latency_max_circuit22)
                latency_all_max_circuit22 = latency_max_circuit22;
            if(latency_all_min_circuit22>latency_min_circuit22)
                latency_all_min_circuit22 = latency_min_circuit22;

            if(latency_all_max_circuit23<latency_max_circuit23)
                latency_all_max_circuit23 = latency_max_circuit23;
            if(latency_all_min_circuit23>latency_min_circuit23)
                latency_all_min_circuit23 = latency_min_circuit23;


            if(latency_all_max_circuit30<latency_max_circuit30)
                latency_all_max_circuit30 = latency_max_circuit30;
            if(latency_all_min_circuit30>latency_min_circuit30)
                latency_all_min_circuit30 = latency_min_circuit30;
            
            if(latency_all_max_circuit31<latency_max_circuit31)
                latency_all_max_circuit31 = latency_max_circuit31;
            if(latency_all_min_circuit31>latency_min_circuit31)
                latency_all_min_circuit31 = latency_min_circuit31;

            if(latency_all_max_circuit32<latency_max_circuit32)
                latency_all_max_circuit32 = latency_max_circuit32;
            if(latency_all_min_circuit32>latency_min_circuit32)
                latency_all_min_circuit32 = latency_min_circuit32;

            if(latency_all_max_circuit33<latency_max_circuit33)
                latency_all_max_circuit33 = latency_max_circuit33;
            if(latency_all_min_circuit33>latency_min_circuit33)
                latency_all_min_circuit33 = latency_min_circuit33;
...
// /*
    //always @(posedge clk_global_ori) clock_global_2 <= ~clock_global_2;
    always @(posedge clk_global_ori) begin
         if((k%400)<200) clk_global_tmp <=  #((k%400)*0.8/400.00) ~clk_global_tmp;
         else clk_global_tmp <= #(((k%400)-200)*0.8/400.00) ~clk_global_tmp;
     end
     always @(*) begin
         clk_global <= ((k%400)<200) ? clk_global_tmp : ~clk_global_tmp;
     end

    // // always @(*) begin
    // //     clock_global_true = global_flag ? clock_global_2 : clk_global;
    // // end
    ...
    // end
    // always @(*) begin
    //     clk0 <= (j<max_T) ? clk0_tmp : ~clk0_tmp;
    // end

    // always @(posedge clk1_ori) begin
    //     if(j<max_T) clk1_tmp <= #(j*0.8/400.00) ~clk1_tmp;
    //     else clk1_tmp <= #((j-max_T)*0.8/400.00) ~clk1_tmp;
    // end
    // always @(*) begin
    //     clk1 <= (j<max_T) ? clk1_tmp : ~clk1_tmp;
    // end

    // always @(posedge clk2_ori) begin
    //     if(j<max_T) clk2_tmp <= #(j*0.8/400.00) ~clk2_tmp;
    //     else clk2_tmp <= #((j-max_T)*0.8/400.00) ~clk2_tmp;
    // end
    // always @(*) begin
    //     clk2 <= (j<max_T) ? clk2_tmp : ~clk2_tmp;
    // end

    // always @(posedge clk3_ori) begin
    //     if(j<max_T) clk3_tmp <= #(j*0.8/400.00) ~clk3_tmp;
    //     else clk3_tmp <= #((j-max_T)*0.8/400.00) ~clk3_tmp;
    // end
    // always @(*) begin
    //     clk3 <= (j<max_T) ? clk3_tmp : ~clk3_tmp;
    // end

    // always @(posedge clk4_ori) clk4 <= #(0*0.8/400.00) ~clk4;
    // always @(posedge clk5_ori) clk5 <= #(0*0.8/400.00) ~clk5;
    // always @(posedge clk6_ori) clk6 <= #(0*0.8/400.00) ~clk6;
    // always @(posedge clk7_ori) clk7 <= #(0*0.8/400.00) ~clk7;
    
    //  always @(posedge clk8_ori) begin
    //     if(j<max_T) clk8_tmp <= #(j*0.8/400.00) ~clk8_tmp;
    //     else clk8_tmp <= #((j-max_T)*0.8/400.00) ~clk8_tmp;
    // end
    // always @(*) begin
    //     clk8 <= (j<max_T) ? clk8_tmp : ~clk8_tmp;
    // end

    // always @(posedge clk9_ori) begin
    //     if(j<max_T) clk9_tmp <= #(j*0.8/400.00) ~clk9_tmp;
    //     else clk9_tmp <= #((j-max_T)*0.8/400.00) ~clk9_tmp;
    // end
    // always @(*) begin
    //     clk9 <= (j<max_T) ? clk9_tmp : ~clk9_tmp;
    // end

    // always @(posedge clk10_ori) begin
    //     if(j<max_T) clk10_tmp <= #(j*0.8/400.00) ~clk10_tmp;
    //     else clk10_tmp <= #((j-max_T)*0.8/400.00) ~clk10_tmp;
    // end
    // always @(*) begin
    //     clk10 <= (j<max_T) ? clk10_tmp : ~clk10_tmp;
    // end

    // always @(posedge clk11_ori) begin
    //     if(j<max_T) clk11_tmp <= #(j*0.8/400.00) ~clk11_tmp;
    //     else clk11_tmp <= #((j-max_T)*0.8/400.00) ~clk11_tmp;
    // end
    // always @(*) begin
    //     clk11 <= (j<max_T) ? clk11_tmp : ~clk11_tmp;
    // end

    // always @(posedge clk12_ori) clk12 <= #(0*0.8/400.00) ~clk12;
    // always @(posedge clk13_ori) clk13 <= #(0*0.8/400.00) ~clk13;
    // always @(posedge clk14_ori) clk14 <= #(0*0.8/400.00) ~clk14;
    // always @(posedge clk15_ori) clk15 <= #(0*0.8/400.00) ~clk15;
